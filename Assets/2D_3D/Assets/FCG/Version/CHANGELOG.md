...
- Fixed a bug from version 3.5.1 (Day/Night system error)
- Fixed other bugs from version 3.5.1

3.5.1

- Fixed bug from version 3.5.0 (error when adding vehicles)

3.5.0

- Added 72 more buildings
- Added an additional area with overpasses
