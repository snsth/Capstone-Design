...
namespace FCG
{
    public class FCityGenerator : EditorWindow
    {
        ...
        public void HideLadders()
        {
            ...
            GameObject[] tempArray = Object.FindObjectsByType<GameObject>(FindObjectsInactive.Include, FindObjectsSortMode.None).Where(g => g.name == "RayCast-HideLadder").ToArray();
        ...
        void OnGUI()
        {
            ...
            if (GUILayout.Button("Remove Traffic System"))
            {
                ...
                DestroyImmediate(Object.FindFirstObjectByType<TrafficSystem>().gameObject);
                DestroyImmediate(GameObject.Find("CarContainer"));
            }
            ...
            if (rh != trafficLightHand || japanTL != japanTrafficLight || ht != heavyTraffic)
            {
                rh = trafficLightHand;
            ...
            if (GUILayout.Button("Combine Meshes"))
            {
                ...
                my_Modules = Object.FindObjectsByType<GameObject>(FindObjectsInactive.Include, FindObjectsSortMode.None).Where(g => g.name == "Marcador").ToArray();
                ...
                GameObject[] myModules = Object.FindObjectsByType<GameObject>(FindObjectsInactive.Include, FindObjectsSortMode.None).Where(g => g.name == "_block").ToArray();
        ...
        private void InverseCarDirection(int trafficHand)
        {
            ...
            if (Object.FindFirstObjectByType<TrafficSystem>())
                trafficSystem = Object.FindFirstObjectByType<TrafficSystem>();
