...
namespace FCG
{
    ...
    public class TrafficSystem : MonoBehaviour
    {
        ...
        public void GetWpData()
        {
            ...
            FCGWaypointsContainer[] ts = Object.FindObjectsByType<FCGWaypointsContainer>(FindObjectsSortMode.None);
        ...
        public void LoadCars(int right_Hand)
        {
            ...
            */
            ...
            ts = Object.FindObjectsByType<FCGWaypointsContainer>(FindObjectsSortMode.None);
            n = ts.Length;
        ...
        public void LoadCars2()
        {
            ...
            {
                FCGWaypointsContainer[] _ts = Object.FindObjectsByType<FCGWaypointsContainer>(FindObjectsSortMode.None);
        ...
        public void DeffineDirection(int hand_Right)
        {
            ...
            GameObject[] roadMark = Object.FindObjectsByType<GameObject>(FindObjectsInactive.Include, FindObjectsSortMode.None).Where(g => g.name.Equals("Road-Mark")).ToArray();
            ...
            roadMark = Object.FindObjectsByType<GameObject>(FindObjectsInactive.Include, FindObjectsSortMode.None).Where(g => g.name.Equals("Road-Mark-Rev")).ToArray();
            for (int i = 0; i < roadMark.Length; i++)
